...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        if sender:
            user = await database_sync_to_async(AccountUser.objects.get)(id=sender)
...
#         print('self.chatroom_name:', self.chatroom_name)
#         # Join the room group
#         await self.channel_layer.group_add(
#             self.room_group_name,
#             self.channel_name,
...
#     async def create_message(self, message):
#         chatroom = await database_sync_to_async(self.get_room)(self.chatroom_name)
#         user = self.scope['user']
#         print('create user', user)
...
#             'content': new_message.content,
#             'timestamp': new_message.timestamp.isoformat(),
#             'user': new_message.user.user_id,
#         }

#         return json_message

#     def get_room(self, chatroom_name):
#         print('chat room name:',chatroom_name)
